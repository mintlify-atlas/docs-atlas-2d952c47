...
<Info>
  **Need Help?** Join the discussion on [GitHub Issues](https://github.com/tu-usuario/PaparcApp/issues) or check the [Quick Start Guide](/quickstart) for a faster setup.
</Info>